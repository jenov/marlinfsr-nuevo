...
_(Thanks to Joe B. for this editorial help)_
  ...
  On the Tx/Rx you can connect (with a tablecloth) an ESP/MKS_Wifi module or your Raspberry/Octoprint. The BAUDS setting is the same as that of the printer (115200 or 25000).
