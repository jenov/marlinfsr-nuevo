...
## 3.4. Various assembly
 ### Wiring for mounting Esp8266, filament detector, TFT serial(BTT, DWIN), temperature probes, relay control, etc.
  ...
  3. Wiring of a TFT screen in serial mode (BTT-TFT or DWIN).
      ...
      ![Wiring for SR Serial](./images/Serial_TFT.png)
      ![Wiring for SR Serial2](./images/Serial_TFT2.png)
      ...
      ![Wiring for SR LCD](./images/LCD_TFT.png)
      ![Wiring for SR LCD2](./images/LCD_TFT2.png)
      ...
      For this you have to declare a second SERIAL port in the firmware
        ...
        #define NUM_SERIAL 2" 
      or use the option "w".
      and make a 4-wire cable using the two pins of the WiFi socket (PA10/PA9 for TX/RX) and two wires (5V/Ground) for power supply.

      ![Wiring for QQSP Serial](./images/Serial_TFT35v3.png)
      ...
      ![Wiring for QQSP Serial2](./images/MOD-Serial_TFT.png)
