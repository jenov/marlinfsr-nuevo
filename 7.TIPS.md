...
## 7.3. **Hardware**
  ...
  **After UPDATE**.
   ...
   **Stock Screen**: with GCode command "M995""
  ...
  Many users encounter problems with their SR BMG extruder and replace it with another. 
  ...
  - Internal flaring of PTFE tube end (blue circle) to improve filament sliding (purple arrows).
