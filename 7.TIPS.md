...
## 7.3. **Hardware**
  ...
  **Name of the FLSUN(Stock) firmware file:**
  ...
  - example for a "QQS" or a "Q5" Stock : 
  ...
  Note: You can also reverse the connector 180° to change the direction.
...
2- Download the ZIP pack of the latest stable version of Marlin 2.0.x (.zip) from the "FLSUN" branch or my latest released version for FLSun Deltas. Unzip it wherever you want.
...
5- Define the used environment for example 
  ...
  - Q5      =>  "env = mks_robin_nano35".
  - SR-Nano =>  "env = mks_robin_nano_v3_usb_flash_drive_msc".
...
8-📦️If you succeeded (result message in green), you will find the firmware in the directory (**dot.pio/build/NAME_OF_ENV/**) at the root of the source directory.
  ...
  - Q5      =>  "env = mks_robin_nano35/**Robin_nano35.bin**".
  - SR-Nano =>  "env = mks_robin_nano_v3_usb_flash_drive_msc/**Robin_nano_v3.bin**".
