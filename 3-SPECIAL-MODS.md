...
## 3.2 TMC2209 Single wire
  - Wiring for UART mode.
    ***Some Warning !!*** 
    ...
    thermal sheath.
    ![2209_Caution](./images/Wire2209-0.png)
    ...
    ![2209-1](./images/Wire2209-1.png)
    ![2209-2](.images/Wire2209-2.png)
    ![2209-3](.images/Wire2209-3.png)

## 3.3 Raspberry
  - Improve your Raspberry (Bauds, plugins, Network).
  
    ![Wiring for Raspberry](./images/WireRPI.png)
