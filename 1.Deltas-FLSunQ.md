...
## 1.3 **Hardware for the FLSunQ printers**
   ...
   **You You have to rename the firmware name to "Robin_nano.bin" instead of "Robin_mini.bin".**
  ...
  ### 1.3.4 Others MotherBoards
   ...
   Link to firmwares: [SKR](https://github.com/Foxies-CSTL/Marlin_2.1.x/tree/Firmwares/QQS_SKR)=>(**Header-Board-firmware.bin**)
