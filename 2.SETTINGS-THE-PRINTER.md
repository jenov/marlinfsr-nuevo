  ### HELP - PROCEDURE - TIPS 
  After the flash, you must **RESET** your printer(QQS, Q5, SR)!!
...
## 2.2 Z_OffSet
 ###  **Perform a Z offset:**
  ...
  - Note: The bed is heated to 60°C (default) before starting and follow the instructions at the bottom of the screen.
   ...
   After run the "ZProbe Wizard", it makes a "HOME" and asks you to put the probe on (touch the bottom of the screen to confirm),
   heats the bed to 60°C and makes a single probing. After that, it asks you to remove the probe (touch the bottom of the screen to confirm)
